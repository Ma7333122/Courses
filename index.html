...
<head>
    ...
    <title>كورسات يوديمي بأسعار مذهلة - ابدأ من 50 جنيه فقط!</title>
    <meta name="description" content="احصل على أفضل كورسات يوديمي في جميع المجالات بأسعار تبدأ من 50 جنيهاً فقط! برمجة، لغات، تصميم، تسويق والمزيد">
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>🔥 كورسات يوديمي بأسعار لا تصدق! 🔥</h1>
        ...
        <div class="content">
            <div class="pricing">
                ...
                <p>كورسات بأسعار تبدأ من</p>
                <div class="price-tag">50 جنيه مصري فقط!</div>
                <p>لأفضل الكورسات على منصة يوديمي العالمية</p>
            </div>
            ...
            <div class="categories">
                ...
                <div class="category">🤖 الذكاء الاصطناعي</div>
                <div class="category">📈 إدارة الأعمال</div>
            </div>
            ...
            <div class="features">
                ...
                <div class="feature">
                    ...
                    <span>مناهج تعليمية متطورة</span>
                </div>
            </div>
            
            <div class="contact">
                <p>للحصول على التفاصيل الكاملة للكورسات والأسعار:</p>
                <div class="phone-number">01010421571</div>
                <p>راسلنا على الواتساب للحصول على القائمة الكاملة للكورسات المتاحة</p>
            ...
            <div class="note">
                ...
                <p>📞 اتصل بنا الآن ولا تفوت هذه الفرصة!</p>
            </div>
        </div>
        
        <div class="footer">
            <p>© 2023 كورسات يوديمي بأسعار مذهلة | جميع الحقوق محفوظة</p>
        </div>
    </div>
</body>
</html>